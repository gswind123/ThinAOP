...
namespace ThinAOP
{
    ...
    {
        const string AssemblyName = "ThinAOP.DynamicAssembly";
        const string AssemblyFileName = "ThinAOP.DynamicAssembly.dll";
        const string ModuleName = "ThinAOP.DynamicModule";
        const string TypeNameFormat = "ThinAOP.Dynamic{0}Type";
        ...
        void BuildMethod(MethodInfo methodInfo)
        {
            ...
            var preAspectLocal = generator.DeclareLocal(typeof(ThinAOP.PreAspectAttribute));
            ...
            generator.Emit(OpCodes.Ldloc, contextLocal);
            generator.Emit(OpCodes.Callvirt,
                typeof(ThinAOP.AspectAttribute).GetMethod("Action", new Type[] { typeof(InvokeContext) }));
            ...
            //var methodInfoLocal = generator.DeclareLocal(typeof(System.Reflection.MethodInfo));
            var postAspectLocal = generator.DeclareLocal(typeof(ThinAOP.PostAspectAttribute));
            ...
            //var methodInfoLocal = generator.DeclareLocal(typeof(System.Reflection.MethodInfo));
            var exAspectLocal = generator.DeclareLocal(typeof(ThinAOP.PostAspectAttribute));
